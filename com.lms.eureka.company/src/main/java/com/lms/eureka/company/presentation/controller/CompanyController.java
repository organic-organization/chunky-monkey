...
public class CompanyController {
    ...
    public ResponseEntity<String> createCompanyProducts(@PathVariable(name = "companyId") UUID companyId,
    ...
    public ResponseEntity<?> getCompanyProducts(@PathVariable(name = "companyId") UUID companyId,
        ...
        return ResponseEntity.ok()
                .body(companyService.findCompanyProducts(companyId, search, pageable));
    }
